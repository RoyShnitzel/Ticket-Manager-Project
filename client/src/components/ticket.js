...
function Ticket(props) {
  ...
  return (
    <div className="ticket">
      <button className="favoriteButton" onClick={() => props.favoriteFunc(ticketId, favorite)}>{favorite ? <i className="fa fa-times" aria-hidden="true" /> : <i className="fa fa-star" />}</button>
